...
<template>
  ...
  >
    <SelectTrigger
      class="flex w-full items-center justify-between gap-2 h-8.5 px-3 text-sm text-on-surface bg-surface-bright/40 border-1 border-solid border-outline-variant/50 rounded-lg cursor-pointer outline-none focus-visible:outline-none transition-[border-color,box-shadow] duration-250 hover:border-on-surface/30 data-[state=open]:border-primary data-[state=open]:shadow-[0_0_0_2px_rgb(var(--s-primary)/0.25)] disabled:opacity-50 disabled:cursor-not-allowed"
    >
      <SelectValue>
    ...
    <SelectPortal>
      <SelectContent
        position="popper"
        :side-offset="4"
        class="z-400 max-h-60 min-w-[var(--reka-select-trigger-width)] overflow-hidden rounded-xl bg-surface-bright border-1 border-solid border-outline-variant/30 shadow-lg data-[state=open]:animate-select-in data-[state=closed]:animate-select-out"
      >
