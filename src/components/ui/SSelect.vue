  ...
  >
    ...
    <SelectPortal>
      <SelectContent
        position="popper"
        :side-offset="4"
        class="z-400 max-h-60 min-w-[var(--reka-select-trigger-width)] overflow-hidden rounded-xl bg-surface-bright border border-solid border-outline-variant/30 shadow-lg data-[state=open]:animate-select-in data-[state=closed]:animate-select-out"
      >
