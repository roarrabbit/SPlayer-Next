...
/** 内容区域样式 */
const contentClass =
  "z-300 min-w-32 max-w-52 rounded-lg bg-surface-bright shadow-lg p-1 text-sm origin-top-left data-[state=open]:animate-popover-in data-[state=closed]:animate-popover-out";
